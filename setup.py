...
setup(
    name="export-pdfannots",
    version=__version__,
    description="export-pdfannots: easily migration of the pdfannots outputs to other software or other formats",
    author="Zejiang Shen",
    author_email="zejiangshen@gmail.com",
    license="MIT",
    url="https://github.com/lolipopshock/export-pdfannots",
    package_dir={"": "src"},
